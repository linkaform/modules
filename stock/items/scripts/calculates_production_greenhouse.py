...
# def calculates_inventory_greenhouse(plant_info, planting_house, ready_date, plant_data, grow_weeks, force_lot=False ):
...
#             '645576e878f3060d1f7fc61b': grow_weeks,
...
# def calculates_production_warehouse(current_record):
...
#         total_produced += production['61f1fcf8c66d2990c8fc7cc3']
#         if production_status == 'progress':
...
#     res = []
#     current_record['answers']['64ed5839a405d8f6378edf5f'] = total_produced
#     for ready_date, plant_data in new_production.items():
#         res.append(calculates_inventory_greenhouse(plant_info, planting_house, ready_date, plant_data, grow_weeks, force_lot=force_lot))
#     return res
