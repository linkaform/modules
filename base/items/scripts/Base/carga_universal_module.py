...
class CargaUniversal(CargaUniversal):
    ...
    def carga_doctos_records(self, records, pos_field_dict, files_dir, nueva_ruta, id_forma_seleccionada, dict_catalogs, group_records):
            ...
            if dict_records_to_multi['create']:
                ...
                print('dict_records_to_multi=',dict_records_to_multi)
...
if __name__ == '__main__':
    ...
    file_url = class_obj.answers[class_obj.f['field_id_xls']]['file_url']
    form_id = class_obj.unlist(class_obj.answers[class_obj.CATALOGO_FORMAS_CAT_OBJ_ID][class_obj.mf['form_id']])

    print('form_id', form_id)
    print('file_url', file_url)
    header, records = class_obj.upfile.get_file_to_upload(file_url=file_url, form_id=form_id)
    print('header', header)
    print('records', records)
    records, pos_field_dict, files_dir, nueva_ruta, id_forma_seleccionada, dict_catalogs, group_records = class_obj.carga_doctos_headers(own_header=header,form_id_to_load=form_id)
