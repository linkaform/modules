...
if __name__ == "__main__":
    ...
    if res.get('status_code') == 0:
        ...
        if res.get('deleted'):
            current_record['answers']['abcde00010000000a0000000'] = 'eliminado'
        else:
            current_record['answers']['abcde0001000000000000000'] = data.get('dag_id')
            current_record['answers'].update(get_dag_dates(data))
            if res.get('is_paused') == True:
                current_record['answers']['abcde00010000000a0000000'] = 'pausado'
            else:
                current_record['answers']['abcde00010000000a0000000'] = 'corriendo'
