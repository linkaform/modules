...
class Reports(Reports):
    ...
    def get_S4_requiers_by_year_week(self):
        query = {
            ...
            "query" :[
                    ...
                    {"$project":{
                        ...
                        "year_week":f"$answers.{self.f['stage_4_plan_require_yearweek']}",
                        "req":f"$answers.{self.f['stage_4_plan_requierments']}",
                    }},
                    {"$project":{
                        "_id":0,
...
if __name__ == "__main__":
    ...
    query = report_obj.get_S4_requiers_by_year_week()
