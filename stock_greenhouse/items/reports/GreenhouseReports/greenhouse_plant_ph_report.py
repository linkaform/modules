...
class Reports(Reports):
    ...
    # --- FORMAT
    def set_format_average(self, data):
        list_day = [];
        dic_plants = {};
        for x in data:
            ...
            if created_at !='' and created_at not in list_day:
                list_day.append(created_at)
        ...
        for key in dic_plants:
            ...
            for day in list_day:
                ...
                for value_plant in data_plant:
                    ...
                    if created_at == day:
                        value_ph_day = ph_data_avg
                list_set['data'].append(value_ph_day)
                    

            list_datasets.append(list_set)
    ...
    def set_format_data(self, data):
        ...
        for key in dic_plants:
            ...
            for value_plant in data_plant:
                ...
                list_set['data'].append({'y':ph_data,'x':created_at})
            list_datasets.append(list_set)  
        ...
        return dic_graphic,list_datatable
    # --- QUERY
        ...
        query = [
            ...
            },
            {
                "$project": {
                    ...
                    "created_at": {"$dateToString":{"date":"$_id.created_at","format":"%Y-%m-%d"}},
                    "ph_data_avg": "$ph_data_avg",
...
if __name__ == "__main__":
    ...
    if date_to or date_from:
        ...
        response_data_graphic, response_data_table = report_obj.query_get_data(date_from, date_to, product_code, lot_number)

    sys.stdout.write(simplejson.dumps(
        {
            "firstElement":response_data_table,
            "secondElement":response_average,
            "thirdElement":response_data_graphic,
        },
    ))
